...
public class S3Interfacer {
    ...
    void uploadFileToCloud(String filename, String key) {
        ...
        System.out.println("Uploading file:" + filename + "k=" + key);

        s3.putObject(new PutObjectRequest("ourdvsbkt", key, new File(filename)));

        Main.instance.writetolog("Uploaded the file: " + filename + " to cloud in bucket ourdvsbkt");
    ...
    void downloadFileFromCloud(String filename, String key) {
        ...
        S3Object object = s3.getObject(new GetObjectRequest("ourdvsbkt", key));
